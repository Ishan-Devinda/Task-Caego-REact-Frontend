...
import stockchecking from '../Access/work1.png';
import loading from '../Access/work2.jpg';
import aircargo from '../Access/air-cargo.png';
import logo01 from '../Access/logo1 (1).png';
import logo02 from '../Access/logo1 (2).png';
import logo03 from '../Access/logo1 (3).png';
import logo04 from '../Access/logo2 (1).png';
import logo05 from '../Access/logo2 (2).png';
import msg from '../Access/msg.jpg'
    ...
    return (
        ...
        <div>
            ...
            <section id = "client-logo-section">
                ...
                <img src={logo02} alt="Background" />
                <img src={logo03} alt="Background" />
                <img src={logo04} alt="Background" />
                <img src={logo05} alt="Background" />
            </section>


            <section id="our-service-section">
               <div class="service-content">
                   <p className='top'>Integer Congueelit</p>
                   <h1>Latest Newes</h1>
                    <div class="different-service-container">
                        <div class="diferent-services">
                            <div class="air-cargo">
                                <img class="air-cargo-img" src={aircargo} />
                                <div class="air-cargo-text">
                                    <h2 className='cur'>CURABITURLOREM USIM QUIS</h2>
                                    <button>
                                        <p>Admin</p>
